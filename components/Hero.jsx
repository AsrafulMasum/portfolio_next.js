...
function Hero() {
  return (
    <div className="lg:h-screen bg-dark_black py-20 text-white">
      <div className="h-full max-w-screen-xl mx-4 md:mx-10 xl:mx-auto flex flex-col-reverse lg:flex-row justify-between items-center gap-16 lg:gap-0">
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="h-full lg:w-1/2 flex flex-col justify-center gap-10 text-primary"
        >
          <motion.h4 variants={textVariants} className="text-3xl lg:text-5xl font-medium tracking-wide text-white">
          ...
          <motion.p variants={textVariants} className="text-white">
            I&#39;m a skilled <span className="font-bold text-lg text-primary">MERN</span> stack web developer with expertise in
            building dynamic and responsive web applications using <span className="text-primary font-bold text-lg">MongoDB,
